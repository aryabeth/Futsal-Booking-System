...
<head>
    ...
    <title>Koreksi Barang - Paragon Futsal</title>
    ...
    <div class="content-wrapper">
        <div class="isi">
            <div class="row pad-botm">
                <div class="col-md-12">
                    <h4 class="header-line">Transaksi Koreksi Barang </h4>
                    <div class="tengah">
                        <button class="btn btn-primary btn-xs" data-toggle="modal" data-target="#addtrans">Tambah Koreksi</button>
                    </div>
                </div>
            </div>
    ...
    <div class="modal fade" id="addtrans" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog"  style="width: 500px;">
            <div class="modal-content">
                <form action="koreksibarang/tambah" method="post">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                        <h4 class="modal-title tengah">Transaksi Koreksi Barang</h4>
                    </div>
    ...
    $(document).ready(function() {
        ...
        $('#namaBarang').focus(function(){
            ...
            $input.change(function() {
                ...
                var index = namabarang.indexOf(current);
        ...
        $('#kode').focus(function(){
            ...
            $input2.change(function() {
                ...
                var index = kodebarang.indexOf(current);
