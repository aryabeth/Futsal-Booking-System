...
<body>
    ...
    <div class="content-wrapper">
        <div class="isi">
            <div class="row pad-botm">
                <div class="col-md-12">
                    <h4 class="header-line">Transaksi Parkir </h4>
                    <div class="tengah">
                        <button class="btn btn-primary btn-xs" data-toggle="modal" data-target="#addparkir"> Add Parkir</button>
                    </div>
            ...
            <div class="row" style="margin-top: -20px;">
                <div class="col-md-12">
                    ...
                    <table class="table table-striped data-table table-bordered table-hover" id="tabelParkir">
                        <thead>
                            <tr class="success">
                                <th>#</th>  
                                <th>Tanggal</th>
                                <th>Nota   </th>
                                <th>Nama Penyetor Parkir</th>
                                <th>Jumlah</th>
                                <th>Keterangan</th>
                                <!-- <th>Status</th>
                                <th>Act</th> -->
                        ...
                        <tbody>
                            <?php
                                $i = 1;
                                $jml = 0;
                                foreach($listparkir as $data){
                                    if (substr($data->jml,0,1) != '-') {
                                        $jml += $data->jml;
                                    }
                                    echo '
                                    <tr>
                                        <td class="tengah">'.$i++.'</td>
                                        <td>'.convertDate($data->tgl_nota).'</td>
                                        <td class="id_edit">'.$data->id_nota.'</td>
                                        <td>'.$data->nama_penyetor.'</td>
                                        <td>Rp. '.number_format($data->jml).'</td>
    ...
    <script type="text/javascript">
        ...
        function del_override(id){
            $.ajax({
                url : "<?php echo site_url('parkir/ajax_override_pengguna')?>",
                    type: "POST",
                    ...
                    success: function(data)
                    {
                        ...
                        if(data.status) //if success close modal and update input main-form
                        {
                            ...
                            if (a == true) {
                                $.ajax({
                                    url: 'parkir/hapus_parkir/'+id,
                                    success:function (data) {
                                        console.log(data);
                                        alert(id+" berhasil dihapus !");
                                        window.location.replace("<?php echo base_url()?>parkir");
                                    },error:function(data){
                                        console.log(data);
                                    }
                                });
    ...
    <!-- modal -->
    <div class="modal fade" id="addparkir" tabindex="-1" role="dialog" aria-labelledby="addparkir" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="parkir/tambah" method="post">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                        <h4 class="modal-title tengah">Add Parkir</h4>
                    </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                    ...
                                    <input type="" id="" class="form-control" name="tgl_waktu" style=""> -->
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                    <input type="text" id="penyetor" class="form-control" name="penyetor" required>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-success">Add Parkir</button>
                    </div>
                </form>
            </div>
        </div>
