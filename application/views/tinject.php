...
<head>
    ...
    <title>Transaksi Cash Inject - Paragon Futsal</title>
</head>
<body>
    ...
    <div class="content-wrapper">
        <div class="isi">
            <div class="row pad-botm">
                <div class="col-md-12">
                    <h4 class="header-line">Transaksi Cash Inject </h4>
                    <div class="tengah">
                        <button class="btn btn-primary btn-xs" onclick="add_cash_inject()">Add Cash Inject</button>
                    </div>
                </div>
            </div>
            <div class="row" style="margin-top: -20px;">
                <div class="col-md-12">
                    <table class="table table-striped table-bordered table-hover" id="tabel-cash_inject">
                        <thead>
                            <tr class="success">
                                <th>#</th>  
                                <th>Tanggal / Waktu</th>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            table = $('#tabel-cash_inject').DataTable({
                ...
                "ajax": {
                    "url": "<?php echo site_url('tinject/ajax_list')?>",
                    "type": "POST"
                },
            ...
            // set nota options value
            $.ajax({
                url : "<?php echo site_url('tinject/ajax_get_nota')?>",
                type: "GET",
                dataType: "JSON",
                success: function(data)
                {
                    // data.length-1 --> menu KOREKSI katanya diabaikan dulu
                    for(var i=0; i<data.length-1; i++) {
                        $('[name="nota"]').append('<option id="opt' + i + '"></option>');
        ...
        function add_cash_inject()
        {
            ...
            $('#modal-cashinject').modal('show'); // show bootstrap modal when complete loaded
            $('#modal-cashinject .modal-title').text('Add Cash Inject'); // Set Title to Bootstrap modal title
        }
        ...
        function save()
        {
            ...
            if(save_method == 'add') {
                url = "<?php echo site_url('tinject/ajax_add')?>";
            } else {
                url = "<?php echo site_url('tinject/ajax_update')?>";
            }
        ...
        function save_override()
        {
            ...
            // ajax adding data to database
            $.ajax({
                url : "<?php echo site_url('tinject/ajax_override_pengguna')?>",
                type: "POST",
    ...
    <!-- BOOTSTRAP MODAL -->
    <div class="modal fade" id="modal-cashinject" tabindex="-1" role="dialog" aria-labelledby="modal-cashinject" aria-hidden="true" data-backdrop="static" data-keyboard="false">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    <h4 class="modal-title tengah">Add Cash Inject</h4>
                </div>
                <div class="modal-body form">
                    <form action="#" id="main-form" class="form-horizontal">
                        <input type="hidden" value="" name="id_inject"/>
